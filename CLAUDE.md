...
### Key Features
- **Multiple Simulation Methods**: Steady horseshoe VLM, steady ring VLM, unsteady ring UVLM, free flight (coupled) simulations that couple the unsteady ring UVLM with MuJoCo physics engine
...
- `debugging_scripts/`: Directory with scripts for active debugging efforts related to coupled simulations
