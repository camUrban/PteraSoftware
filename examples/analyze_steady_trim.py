"""Demonstrates finding the trim condition for a steady simulation.

The script will likely take a few minutes to run, and will log trim progress and results
in a log file.
"""
...
# of engine.
trim_operating_point = ps.operating_point.OperatingPoint(alpha=5.0, externalFX_W=5)
