""" This is script is an example of how to run Ptera Software's steady horseshoe vortex lattice method solver on a
custom airplane."""
...
example_solver = main.steady_horseshoe_vortex_lattice_method.SteadyHorseshoeVortexLatticeMethodSolver(
