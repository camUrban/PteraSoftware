...
lattice method solver on a custom
airplane."""
        ...
        ps.geometry.Wing(  # Give the wing a name, this defaults to "Untitled Wing".
            ...
            wing_cross_sections=[  # Create a new wing cross section object.
                ps.geometry.WingCrossSection(
                    ...
                    # default is 0.0 degrees. We'll set it
                    # to 10.0 degrees to show an example of an aileron deflection.
...
# object. I like to delete the external
# pointers to these objects to ease debugging.
...
# solver. Again, this is unnecessary, I
# just like to do this to ease debugging.
del example_problem
...
ps.output.draw(  # Set the solver to the one we just ran.
    ...
    # solver, no vortices have been shed into
    # the wake. This value defaults to false.
