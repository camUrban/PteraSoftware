""" This is script is an example of how to run Ptera Software's steady ring vortex lattice method solver on a custom
airplane."""
...
example_airplane = main.geometry.Airplane(
    ...
    wings=[
        ...
        main.geometry.Wing(
            ...
            # the chordwise direction, near the leading and trailing edges. The other option is "uniform".
            ...
            wing_cross_sections=[
                ...
                main.geometry.WingCrossSection(
                    ...
                    # Define the deflection of the control surface in degrees. The default is 0.0 degrees. We'll set it
...
# Define a new steady problem. A steady problem contains an airplane object and an operating point object.
example_problem = main.problems.SteadyProblem(
...
# Now, the airplane and operating point object exist within the steady problem object. I like to delete the external
...
example_solver = main.steady_ring_vortex_lattice_method.SteadyRingVortexLatticeMethodSolver(
    # Solvers just take in one attribute: the problem they are going to solve.
    steady_problem=example_problem
)

# Delete the extraneous pointer to the problem as it is now contained within the solver. Again, this is unnecessary, I
...
main.output.draw(
    ...
    # Tell the draw function to not show any wake vortices. As this is a steady solver, no vortices have been shed into
