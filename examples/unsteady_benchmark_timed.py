        ...
        src.pterasoftware.geometry.Wing(
            ...
            wing_cross_sections=[
                src.pterasoftware.geometry.WingCrossSection(
                    ...
                    chord=1.75,
                    airfoil=src.pterasoftware.geometry.Airfoil(name="naca0000",),
                ),
                src.pterasoftware.geometry.WingCrossSection(
                    num_spanwise_panels=num_spanwise_panels,
                    spanwise_spacing="uniform",
...
upper_wing_root_wing_cross_section_movement = src.pterasoftware.movement.WingCrossSectionMovement(
    base_wing_cross_section=example_airplane.wings[0].wing_cross_sections[0],
)

upper_wing_tip_wing_cross_section_movement = src.pterasoftware.movement.WingCrossSectionMovement(
...
example_problem = src.pterasoftware.problems.UnsteadyProblem(movement=movement, only_final_results=True)
