...
class LegacySteadyHorseshoeVortexLatticeMethodSolver:
    ...
    def calculate_solution_velocity(self, point):
        ...
        for wing in self.airplane.wings:
            ...
            # Iterate through this list of panels.
            for panel in wing_panels:
                # Add the velocity induced by this panel's vortex at this point to
                # the total induced velocity.
        ...
        # Return the freestream velocity in geometry axes to the velocity induced by
        # the vortices.
