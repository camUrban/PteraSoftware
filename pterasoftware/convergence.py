...
def _memos_from_disk(
    ...
    This inverts _memos_to_disk against this run's parameter lists. Each memo whose
    ...
    :param memos: The disk memo dictionary mapping each absolute-valued memo key to its
        value, as returned by _load_memo_cache.
    :param ref_problem_hash: The content hash of the reference problem, as returned by
...
def _load_memo_cache(cache_path: Path | None) -> dict[str, float]:
