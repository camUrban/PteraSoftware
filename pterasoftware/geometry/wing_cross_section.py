    ...
    **Citation:**
    ...
    def get_plottable_data(
        ...
        if np.allclose(UserMatrixAxesWcsLp_WcspLpp, UserMatrixAxesWcspLpp):
            ...
            plotter.add_actor(AxesWcsLpWcspLpp_Wcsp_lpp)  # type: ignore[arg-type, unused-ignore]
        else:
            ...
            plotter.add_actor(AxesWcsLp_Wcsp_lpp)  # type: ignore[arg-type, unused-ignore]
            plotter.add_actor(AxesWcspLpp)  # type: ignore[arg-type, unused-ignore]
