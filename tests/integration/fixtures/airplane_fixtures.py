...
def make_steady_validation_airplane():
    ...
    steady_validation_airplane = src.geometry.Airplane(
        wings=[
            src.geometry.Wing(
                symmetric=True,
                wing_cross_sections=[
                    src.geometry.WingCrossSection(
                        airfoil=src.geometry.Airfoil(name="naca2412"),
                    ),
                    src.geometry.WingCrossSection(
                        x_le=1.0,
                        y_le=5.0,
...
def make_multiple_wing_steady_validation_airplane():
    ...
    # Create and return the airplane object.
    multiple_wing_steady_validation_airplane = src.geometry.Airplane(
        wings=[
            src.geometry.Wing(
                symmetric=True,
                ...
                wing_cross_sections=[
                    src.geometry.WingCrossSection(
                        airfoil=src.geometry.Airfoil(name="naca23012"),
            ...
            src.geometry.Wing(
                ...
                wing_cross_sections=[
                    src.geometry.WingCrossSection(
                        airfoil=src.geometry.Airfoil(name="naca0010"),
                        twist=-5.0,
                    ),
                    src.geometry.WingCrossSection(
                        x_le=1.0,
...
def make_asymmetric_unsteady_validation_airplane():
    ...
    # Create and return the airplane object.
    asymmetric_unsteady_validation_airplane = src.geometry.Airplane(
        y_ref=5.0,
        wings=[
            src.geometry.Wing(
...
def make_symmetric_unsteady_validation_airplane():
    ...
    # Create and return the airplane object.
    symmetric_unsteady_validation_airplane = src.geometry.Airplane(
        wings=[
            src.geometry.Wing(
                symmetric=True,
                chordwise_spacing="uniform",
...
def make_symmetric_multiple_wing_unsteady_validation_airplane():
    ...
    # Create and return the airplane object.
    symmetric_multiple_wing_steady_validation_airplane = src.geometry.Airplane(
        wings=[
            src.geometry.Wing(
                symmetric=True,
                chordwise_spacing="uniform",
