"""This module tests the SteadyRingVortexLatticeMethodSolver's surface effect
...
class TestSteadyRingVortexLatticeMethodSurfaceEffect(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.surface_effect_solver = (
            solver_fixtures.make_steady_ring_vortex_lattice_method_surface_effect_solver()
        )
        cls.free_air_solver = (
            solver_fixtures.make_steady_ring_vortex_lattice_method_free_air_solver()
        )
