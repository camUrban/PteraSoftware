"""This module tests the UnsteadyRingVortexLatticeMethodSolver's surface effect
...
class TestUnsteadyRingVortexLatticeMethodSurfaceEffect(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.free_air_solver = (
            solver_fixtures.make_unsteady_ring_vortex_lattice_method_free_air_solver()
        )
    ...
    def test_surface_effect_increases_lift(self) -> None:
        ...
        :return: None
        """
        surface_effect_airplane = self.surface_effect_solver.current_airplanes[0]
        free_air_airplane = self.free_air_solver.current_airplanes[0]
