...
def make_static_core_movement_fixture() -> CoreMovement:
    ...
    :return static_core_movement_fixture: CoreMovement This is the CoreMovement with no
        motion.
    """
...
def make_basic_core_movement_fixture() -> CoreMovement:
    ...
    :return basic_core_movement_fixture: CoreMovement This is the CoreMovement with
        general-purpose values for testing.
    """
    # Initialize the constructing fixtures.
    airplane_movements = [
