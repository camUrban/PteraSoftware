...
def make_basic_line_vortex_fixture():
    ...
    """
    basic_line_vortex_fixture = _aerodynamics._LineVortex(
...
def make_diagonal_line_vortex_fixture():
    ...
    """
    diagonal_line_vortex_fixture = _aerodynamics._LineVortex(
        Slvp_GP1_CgP1=np.array([0.0, 0.0, 0.0], dtype=float),
...
def make_y_aligned_line_vortex_fixture():
    ...
    """
    y_aligned_line_vortex_fixture = _aerodynamics._LineVortex(
...
def make_z_aligned_line_vortex_fixture():
    ...
    """
    z_aligned_line_vortex_fixture = _aerodynamics._LineVortex(
        Slvp_GP1_CgP1=np.array([0.0, 0.0, 0.0], dtype=float),
...
def make_zero_strength_line_vortex_fixture():
    ...
    """
    zero_strength_line_vortex_fixture = _aerodynamics._LineVortex(
        Slvp_GP1_CgP1=np.array([0.0, 0.0, 0.0], dtype=float),
        Elvp_GP1_CgP1=np.array([1.0, 0.0, 0.0], dtype=float),
        strength=0.0,
    )
...
def make_negative_strength_line_vortex_fixture():
    ...
    """
    negative_strength_line_vortex_fixture = _aerodynamics._LineVortex(
        Slvp_GP1_CgP1=np.array([0.0, 0.0, 0.0], dtype=float),
        Elvp_GP1_CgP1=np.array([1.0, 0.0, 0.0], dtype=float),
        strength=-2.5,
    )
...
def make_large_strength_line_vortex_fixture():
    ...
    """
    large_strength_line_vortex_fixture = _aerodynamics._LineVortex(
        Slvp_GP1_CgP1=np.array([0.0, 0.0, 0.0], dtype=float),
        Elvp_GP1_CgP1=np.array([1.0, 0.0, 0.0], dtype=float),
        strength=1e6,
    )
...
def make_offset_line_vortex_fixture():
    ...
    offset_line_vortex_fixture = _aerodynamics._LineVortex(
...
def make_small_line_vortex_fixture():
    ...
    """
    small_line_vortex_fixture = _aerodynamics._LineVortex(
        Slvp_GP1_CgP1=np.array([0.0, 0.0, 0.0], dtype=float),
...
def make_long_line_vortex_fixture():
    ...
    """
    long_line_vortex_fixture = _aerodynamics._LineVortex(
        Slvp_GP1_CgP1=np.array([0.0, 0.0, 0.0], dtype=float),
