...
This module contains the following functions:
    ...
    make_static_wing_cross_section_movement_fixture: This method makes a
    fixture that is a WingCrossSectionMovement with all parameters zero (no
    movement).

    make_basic_wing_cross_section_movement_fixture: This method makes a fixture
    that is a WingCrossSectionMovement with general-purpose moderate values.

    make_Lp_only_wing_cross_section_movement_fixture: This method makes a
    fixture that is a WingCrossSectionMovement where only Lp_Wcsp_Lpp moves.

    make_angles_only_wing_cross_section_movement_fixture: This method makes a
    fixture that is a WingCrossSectionMovement where only angles_Wcsp_to_Wcs_izyx
    moves.

    make_phase_offset_Lp_wing_cross_section_movement_fixture: This method makes
    a fixture that is a WingCrossSectionMovement with non-zero phase offset for
    Lp_Wcsp_Lpp.

    make_phase_offset_angles_wing_cross_section_movement_fixture: This method
    makes a fixture that is a WingCrossSectionMovement with non-zero phase
    offset for angles_Wcsp_to_Wcs_izyx.

    make_multiple_periods_movement_fixture: This method makes a fixture that is
    a WingCrossSectionMovement with different periods for different dimensions.

    make_custom_spacing_Lp_wing_cross_section_movement_fixture: This method
    makes a fixture that is a WingCrossSectionMovement with a custom spacing
    function for Lp_Wcsp_Lpp.

    make_custom_spacing_angles_wing_cross_section_movement_fixture: This method
    makes a fixture that is a WingCrossSectionMovement with a custom spacing
    function for angles_Wcsp_to_Wcs_izyx.

    make_mixed_custom_and_standard_spacing_movement_fixture: This method makes a
    fixture that is a WingCrossSectionMovement with mixed custom and standard
    spacing functions.
"""
...
def make_multiple_periods_movement_fixture():
    """This method makes a fixture that is a WingCrossSectionMovement with
    different periods for different dimensions.

    :return multiple_periods_movement_fixture: WingCrossSectionMovement
    ...
    multiple_periods_movement_fixture = (
        ps.movements.wing_cross_section_movement.WingCrossSectionMovement(
            base_wing_cross_section=base_wing_cross_section,
    ...
    # Return the WingCrossSectionMovement fixture.
    return multiple_periods_movement_fixture
...
def make_mixed_custom_and_standard_spacing_movement_fixture():
    """This method makes a fixture that is a WingCrossSectionMovement with mixed
    custom and standard spacing functions.

    :return mixed_custom_and_standard_spacing_movement_fixture: WingCrossSectionMovement
    ...
    mixed_custom_and_standard_spacing_movement_fixture = (
        ps.movements.wing_cross_section_movement.WingCrossSectionMovement(
            base_wing_cross_section=base_wing_cross_section,
            ampLp_Wcsp_Lpp=(0.4, 0.3, 0.15),
            periodLp_Wcsp_Lpp=(1.0, 1.0, 1.0),
    ...
    # Return the WingCrossSectionMovement fixture.
    return mixed_custom_and_standard_spacing_movement_fixture
