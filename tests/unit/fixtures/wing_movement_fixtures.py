...
def make_basic_wing_movement_fixture():
    ...
    basic_wing_movement_fixture = ps.movements.wing_movement.WingMovement(
        ...
        periodAngles_G_to_prelimWn_ixyz=(2.0, 2.0, 2.0),
        spacingAngles_G_to_prelimWn_ixyz=("sine", "sine", "sine"),
        phaseAngles_G_to_prelimWn_ixyz=(0.0, 0.0, 0.0),
    )
...
def make_sine_spacing_angles_wing_movement_fixture():
    ...
    :return sine_spacing_angles_wing_movement_fixture: WingMovement
        This is the WingMovement with sine spacing for angles_G_to_prelimWn_ixyz.
    """
    # Initialize the constructing fixtures.
    base_wing = geometry_fixtures.make_origin_wing_fixture()
    wcs_movements = [
    ...
    # Create the WingMovement with sine spacing for angles_G_to_prelimWn_ixyz.
...
def make_uniform_spacing_angles_wing_movement_fixture():
    ...
    :return uniform_spacing_angles_wing_movement_fixture: WingMovement
        This is the WingMovement with uniform spacing for angles_G_to_prelimWn_ixyz.
    """
    # Initialize the constructing fixtures.
    base_wing = geometry_fixtures.make_origin_wing_fixture()
    wcs_movements = [
    ...
    # Create the WingMovement with uniform spacing for angles_G_to_prelimWn_ixyz.
    uniform_spacing_angles_wing_movement_fixture = (
        ps.movements.wing_movement.WingMovement(
            ...
            ampAngles_G_to_prelimWn_ixyz=(10.0, 0.0, 0.0),
            periodAngles_G_to_prelimWn_ixyz=(1.0, 0.0, 0.0),
            spacingAngles_G_to_prelimWn_ixyz=("uniform", "uniform", "uniform"),
            phaseAngles_G_to_prelimWn_ixyz=(0.0, 0.0, 0.0),
        )
    )
...
def make_mixed_spacing_angles_wing_movement_fixture():
    ...
    :return mixed_spacing_angles_wing_movement_fixture: WingMovement
        This is the WingMovement with mixed spacing for angles_G_to_prelimWn_ixyz.
    """
    # Initialize the constructing fixtures.
    base_wing = geometry_fixtures.make_origin_wing_fixture()
    wcs_movements = [
    ...
    # Create the WingMovement with mixed spacing for angles_G_to_prelimWn_ixyz.
    mixed_spacing_angles_wing_movement_fixture = (
        ps.movements.wing_movement.WingMovement(
            ...
            spacingPrelimLer_G_Cg=("sine", "sine", "sine"),
            phasePrelimLer_G_Cg=(0.0, 0.0, 0.0),
            ampAngles_G_to_prelimWn_ixyz=(10.0, 15.0, 8.0),
            periodAngles_G_to_prelimWn_ixyz=(1.0, 1.0, 1.0),
            spacingAngles_G_to_prelimWn_ixyz=("sine", "uniform", "sine"),
            phaseAngles_G_to_prelimWn_ixyz=(0.0, 0.0, 0.0),
        )
    )
...
def make_angles_only_wing_movement_fixture():
    ...
    angles_G_to_prelimWn_ixyz moves.

    :return angles_only_wing_movement_fixture: WingMovement
        This is the WingMovement with only angles_G_to_prelimWn_ixyz movement.
    """
    # Initialize the constructing fixtures.
    base_wing = geometry_fixtures.make_origin_wing_fixture()
    wcs_movements = [
    ...
    angles_only_wing_movement_fixture = ps.movements.wing_movement.WingMovement(
        ...
        spacingPrelimLer_G_Cg=("sine", "sine", "sine"),
        phasePrelimLer_G_Cg=(0.0, 0.0, 0.0),
        ampAngles_G_to_prelimWn_ixyz=(12.0, 8.0, 5.0),
        periodAngles_G_to_prelimWn_ixyz=(1.5, 1.5, 1.5),
        spacingAngles_G_to_prelimWn_ixyz=("sine", "sine", "sine"),
        phaseAngles_G_to_prelimWn_ixyz=(0.0, 0.0, 0.0),
    )
...
def make_phase_offset_angles_wing_movement_fixture():
    """This method makes a fixture that is a WingMovement with non-zero phase offset
    for angles_G_to_prelimWn_ixyz.

    :return phase_offset_angles_wing_movement_fixture: WingMovement
        This is the WingMovement with phase offset for angles_G_to_prelimWn_ixyz.
    """
    # Initialize the constructing fixtures.
    base_wing = geometry_fixtures.make_origin_wing_fixture()
    wcs_movements = [
    ...
    phase_offset_angles_wing_movement_fixture = ps.movements.wing_movement.WingMovement(
        ...
        spacingPrelimLer_G_Cg=("sine", "sine", "sine"),
        phasePrelimLer_G_Cg=(0.0, 0.0, 0.0),
        ampAngles_G_to_prelimWn_ixyz=(10.0, 12.0, 8.0),
        periodAngles_G_to_prelimWn_ixyz=(1.0, 1.0, 1.0),
        spacingAngles_G_to_prelimWn_ixyz=("sine", "sine", "sine"),
        phaseAngles_G_to_prelimWn_ixyz=(45.0, 90.0, -30.0),
    )
...
def make_multiple_periods_wing_movement_fixture():
    ...
    multiple_periods_wing_movement_fixture = ps.movements.wing_movement.WingMovement(
        ...
        spacingPrelimLer_G_Cg=("sine", "sine", "sine"),
        phasePrelimLer_G_Cg=(0.0, 0.0, 0.0),
        ampAngles_G_to_prelimWn_ixyz=(8.0, 10.0, 12.0),
        periodAngles_G_to_prelimWn_ixyz=(0.5, 1.5, 2.5),
        spacingAngles_G_to_prelimWn_ixyz=("sine", "sine", "sine"),
        phaseAngles_G_to_prelimWn_ixyz=(0.0, 0.0, 0.0),
    )
...
def make_custom_spacing_angles_wing_movement_fixture():
    """This method makes a fixture that is a WingMovement with a custom spacing
    function for angles_G_to_prelimWn_ixyz.

    :return custom_spacing_angles_wing_movement_fixture: WingMovement
        This is the WingMovement with custom spacing for angles_G_to_prelimWn_ixyz.
    """
    # Initialize the constructing fixtures.
    base_wing = geometry_fixtures.make_origin_wing_fixture()
    wcs_movements = [
    ...
    custom_spacing_angles_wing_movement_fixture = (
        ps.movements.wing_movement.WingMovement(
            ...
            ampAngles_G_to_prelimWn_ixyz=(10.0, 0.0, 0.0),
            periodAngles_G_to_prelimWn_ixyz=(1.0, 0.0, 0.0),
            spacingAngles_G_to_prelimWn_ixyz=(custom_harmonic, "sine", "sine"),
            phaseAngles_G_to_prelimWn_ixyz=(0.0, 0.0, 0.0),
        )
    )
...
def make_mixed_custom_and_standard_spacing_wing_movement_fixture():
    ...
    mixed_custom_and_standard_spacing_wing_movement_fixture = (
        ps.movements.wing_movement.WingMovement(
            ...
            phasePrelimLer_G_Cg=(0.0, 0.0, 0.0),
            ampAngles_G_to_prelimWn_ixyz=(8.0, 10.0, 6.0),
            periodAngles_G_to_prelimWn_ixyz=(1.0, 1.0, 1.0),
            spacingAngles_G_to_prelimWn_ixyz=("sine", custom_harmonic, "uniform"),
            phaseAngles_G_to_prelimWn_ixyz=(0.0, 0.0, 0.0),
        )
    )
