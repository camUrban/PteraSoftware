...
class TestLcmFunctions(unittest.TestCase):
    ...
    def test_lcm_of_multiples(self) -> None:
    ...
    def test_lcm_non_integer_periods(self) -> None:
    ...
    def test_lcm_multiple_non_integer_periods(self) -> None:
    ...
    def test_lcm_small_periods(self) -> None:
    ...
    def test_lcm_multiple_small_periods(self) -> None:
