...
class TestCoreOperatingPointMovement(unittest.TestCase):
    ...
    def test_base_operating_point_validation(self) -> None:
    ...
    def test_ampVCg__E_validation(self) -> None:
    ...
    def test_periodVCg__E_validation(self) -> None:
    ...
    def test_spacingVCg__E_validation(self) -> None:
    ...
    def test_phaseVCg__E_validation(self) -> None:
    ...
    def test_amp_period_relationship(self) -> None:
    ...
    def test_amp_phase_relationship(self) -> None:
    ...
    def test_spacing_sine_produces_sinusoidal_motion(self) -> None:
    ...
    def test_max_period_with_movement(self) -> None:
    ...
    def test_max_period_long_period(self) -> None:
    ...
    def test_generate_operating_points_parameter_validation(self) -> None:
    ...
    def test_generate_operating_points_returns_correct_length(self) -> None:
    ...
    def test_generate_operating_points_returns_correct_types(self) -> None:
    ...
    def test_generate_operating_points_static_movement(self) -> None:
    ...
    def test_generate_operating_points_different_delta_time(self) -> None:
    ...
    def test_phase_offset_shifts_initial_value(self) -> None:
    ...
    def test_custom_spacing_function_works(self) -> None:
...
class TestCoreOperatingPointMovementImmutability(unittest.TestCase):
    ...
    def test_immutable_base_operating_point_property(self) -> None:
        ...
        with self.assertRaises(AttributeError):
            setattr(self.basic_core_op_movement, "base_operating_point", new_op)

    def test_immutable_ampVCg__E_property(self) -> None:
        """Test that ampVCg__E property is read only."""
        with self.assertRaises(AttributeError):
            setattr(self.basic_core_op_movement, "ampVCg__E", 10.0)

    def test_immutable_periodVCg__E_property(self) -> None:
        """Test that periodVCg__E property is read only."""
        with self.assertRaises(AttributeError):
            setattr(self.basic_core_op_movement, "periodVCg__E", 5.0)

    def test_immutable_spacingVCg__E_property(self) -> None:
        """Test that spacingVCg__E property is read only."""
        with self.assertRaises(AttributeError):
            setattr(self.basic_core_op_movement, "spacingVCg__E", "uniform")

    def test_immutable_phaseVCg__E_property(self) -> None:
        """Test that phaseVCg__E property is read only."""
        with self.assertRaises(AttributeError):
            setattr(self.basic_core_op_movement, "phaseVCg__E", 45.0)
