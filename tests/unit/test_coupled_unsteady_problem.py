...
class TestCoupledUnsteadyProblem(unittest.TestCase):
    ...
    def test_max_wake_rows_from_movement(self) -> None:
    ...
    def test_movement_property_returns_core_movement(self) -> None:
    ...
    def test_get_steady_problem_rejects_negative_step(self) -> None:
