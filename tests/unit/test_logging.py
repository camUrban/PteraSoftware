...
class TestGetLogger(unittest.TestCase):
    ...
    def test_returns_logger_with_package_prefix(self) -> None:
    ...
    def test_hierarchical_naming_with_dots(self) -> None:
    ...
    def test_already_prefixed_name_not_duplicated(self) -> None:
...
class TestSetupLogging(unittest.TestCase):
    ...
    def test_returns_package_logger(self) -> None:
    ...
    def test_default_format_right_pads_level_names(self) -> None:
    ...
    def test_default_format_aligns_messages_across_modules(self) -> None:
    ...
    def test_invalid_level_type_raises_type_error(self) -> None:
        """set_up_logging should raise TypeError for invalid level types."""
        bad_level: Any = 3.14
        with self.assertRaises(TypeError) as context:
            _logging.set_up_logging(level=bad_level)
        self.assertIn("level must be an int or a str", str(context.exception))

    def test_invalid_handler_type_raises_type_error(self) -> None:
        """set_up_logging should raise TypeError for invalid handler types."""
        bad_handler: Any = "not a handler"
        with self.assertRaises(TypeError) as context:
            _logging.set_up_logging(handler=bad_handler)
        self.assertIn(
            "handler must be a logging.Handler or None", str(context.exception)
        )

    def test_invalid_format_string_type_raises_type_error(self) -> None:
        """set_up_logging should raise TypeError for invalid format_string types."""
        bad_format_string: Any = 123
        with self.assertRaises(TypeError) as context:
            _logging.set_up_logging(format_string=bad_format_string)
...
class TestLoggerHierarchy(unittest.TestCase):
    ...
    def test_child_logger_inherits_from_package_logger(self) -> None:
    ...
    def test_child_logger_messages_go_to_package_handler(self) -> None:
